...
const  CancelledTable=()=>{
  ...
  </div>, orderNo: '123', orderDate: '2022-03-01', city: 'New York', customerName: 'Abhisek Dixit', orderValue: 100, status: <Button variant="danger" style={{ color: 'red',borderRadius: '0', borderColor: 'red', background: 'transparent', padding: '0.15rem 0.15rem', fontSize: '0.8rem' }}>Cancelled</Button> },
    { id: 3, icon:"+", checkbox:<input type='checkbox'/>,shoppingIcon:<div>
    <FontAwesomeIcon icon={faShoppingBag} style={{ color: 'green' }} />
  </div>, orderNo: '456', orderDate: '2022-03-02', city: 'Los Angeles', customerName: 'Abhisek Dixit', orderValue: 200, status: <Button variant="danger" style={{ color: 'red',borderRadius: '0', borderColor: 'red', background: 'transparent', padding: '0.15rem 0.15rem', fontSize: '0.8rem' }}>Cancelled</Button> },
