...
const  AWBCreatedTable=()=>{
  ...
  </div>, orderNo: '123', orderDate: '2022-03-01', city: 'New York', customerName: 'Abhisek Dixit', orderValue: 100, status: <Button variant="outline-success" style={{ color: 'yellow',borderRadius: '0', borderColor: 'yellow', background: 'transparent', padding: '0.15rem 0.15rem', fontSize: '0.8rem' }}>AWB Created</Button> },
    { id: 3, icon:"+", checkbox:<input type='checkbox'/>,shoppingIcon:<div>
    <FontAwesomeIcon icon={faShoppingBag} style={{ color: 'green' }} />
  </div>, orderNo: '456', orderDate: '2022-03-02', city: 'Los Angeles', customerName: 'Abhisek Dixit', orderValue: 200, status: <Button variant="outline-success" style={{ color: 'yellow',borderRadius: '0', borderColor: 'yellow', background: 'transparent', padding: '0.15rem 0.15rem', fontSize: '0.8rem' }}>AWB Created</Button> },
...
export default AWBCreatedTable;
